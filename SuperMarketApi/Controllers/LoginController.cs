...
namespace SuperMarketApi.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        [HttpGet("DashBoard")]
        public IActionResult DashBoard(int storeId, int companyId, DateTime fromDate, DateTime toDate, DateTime toDay, DateTime prodfromDate, DateTime prodtoDate)
        {
            SqlConnection sqlCon = new SqlConnection(Configuration.GetConnectionString("myconn"));
            sqlCon.Open();
            ...
            cmd.Parameters.Add(new SqlParameter("@prodfromDate", prodfromDate));
            cmd.Parameters.Add(new SqlParameter("@prodtoDate", prodtoDate));
