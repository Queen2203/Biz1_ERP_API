  ...
  public class PurchaseTrxController : Controller
  {
    ...
    public IActionResult GetPurchaseTrx(JObject objData)
    {
      ...
      catch (Exception ex)
      {
        ...
        [HttpGet("TestPurchaseData")]
        public IActionResult TestPurchaseData(int CompanyId)
        {
            try
            {
                SqlConnection sqlCon = new SqlConnection(Configuration.GetConnectionString("myconn"));
                ...
                SqlCommand cmd = new SqlCommand("dbo.PurchaseIndex_Test", sqlCon);
