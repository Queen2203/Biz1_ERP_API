...
namespace SuperMarketApi.Controllers
{
    ...
    public class InternalController : Controller
    {
        ...
        public InternalController(POSDbContext contextOptions, IConfiguration configuration, ILogger<InternalController> logger)
        {
            db = contextOptions;
        ...
        public IActionResult getStoreList(int CompanyId)
        {
            var response = new
            {
                StoreList = db.Stores.Where(x => x.CompanyId == CompanyId),
        ...
        [HttpPost("corsTest")]
        //[EnableCors("AllowOrigin")]
        public ActionResult corsTest([FromBody]string objData)
        {
            return Ok(objData);
        ...
        //[EnableCors("AllowOrigin")]
        public ActionResult OrdDispatch()
        {
            try
            {
                int result = 0;
                Console.WriteLine("_----------------DIspatch starting--------------_");
